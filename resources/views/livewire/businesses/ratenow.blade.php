    ...
    <form wire:submit.prevent="submitReview">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="mb-6">
                ...
                <input wire:model="contact_phone" type="text" placeholder="Enter the contact number of the business"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                @error('contact_phone')
                    <span class="text-sm text-red-600">{{ $message }}</span>
                @enderror
        ...
        @guest
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input wire:model="reviewer_name" type="text" id="reviewer_name" placeholder="Enter Your Name"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600">
                    @error('reviewer_name')
                        <span class="text-sm text-red-600">{{ $message }}</span>
                    @enderror
                ...
                <div>
                    ...
                    <input wire:model="reviewer_email" type="email" id="reviewer_email" placeholder="Enter your Email"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-primary-600">
