<nav class="bg-[#0000002d] border-gray-200 dark:bg-gray-900 p-6">
                ...
                @guest
                    ...
                    <li>
                        <a href="{{ route('register') }}"
                            class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent {{ $this->isActive('register') }}">
                            Register
